    ...
    <div class="container-fluid abt-section pb-4" >
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row ">
                    <div class="col-md-6 col-sm-12 text-center"><button type="submit" class="white-btn mx-auto">Join us</button></div>
                    <div class="col-md-6 col-sm-12 text-center"><button type="submit" class="white-btn mx-auto">View Course details</button></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class=" course-section">
            <div class="col-md-12"> 
                 <div class="coure-section text-center p-5 text-white"> 
                    ...
                    <p class="p-3">
                    Arena animation kammanahalli -India's premeier Media and Entertainment training
                    ...
                    the most advanced tools and technologies with the help of expert faculty.
                    </p>
                </div>
            </div>
    </div>
