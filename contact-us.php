...
<div class="container-fluid text-white bg-primary">
   <div class="row">
    <div class="col-md-6 p-5 text-center">
        <h2 class="mt-5">GET IN TOUCH WITH US TODAY</h2>
        <p class="mt-5 p-2"> You've got questions, and we have answers. Just send us a message and one of our knowledable support staff will be incontact with you with in 48hours- even on weekends and holidays.</p>
