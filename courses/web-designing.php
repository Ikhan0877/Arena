...
<html lang="en">
<head>
  <title>Courses | Web Designing | Arena Animation Kammanahalli</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
 <link rel="stylesheet" type="text/css" href="css/style.css">
  <meta name="keywords" content=" Web Designing,Web Designing course arena,arena Web Designing,Web Designing,Web Designing course in bangalore,Web Designing course arena,arena Web Designing">
  <meta name="description" content="Web Designing course offered by one of the top instution arena animation Kammanahalli">
...
<body>
    ...
    <div class="row p-5 bg-light border-bottom">
        <div class="col-md-4 course-title">
          <h2 class="mt-5">G W D - WEB DESIGN</h2>
      </div>
